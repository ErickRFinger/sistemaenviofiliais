...
export default function NovoEnvio() {
    ...
    const handleSave = async () => {
        ...
        try {
            // Create shipment header completo
    ...
    return (
        <div className="animate-fade-in grid-responsive mobile-stack" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 400px', gap: '2rem', height: '100%', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', height: '100%' }}>
                <header>
                    <h2 style={{ fontSize: '2rem', fontWeight: '700' }}>Novo Envio</h2>
                    <p style={{ color: 'var(--text-secondary)' }}>Selecione os produtos para montar o lote de envio.</p>
                </header>
            ...
            <div className="glass-panel" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', height: '100%', position: 'sticky', top: 0, overflowY: 'auto' }}>
                ...
                <h4 style={{ fontSize: '1rem', fontWeight: '600', borderBottom: '1px solid var(--border)', paddingBottom: '0.5rem', marginTop: '0.5rem' }}>Produtos a Enviar</h4>
