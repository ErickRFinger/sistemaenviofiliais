...
import { Search, Plus, Minus, Check, Trash2, User, Truck, FileText, ArrowLeft, ShoppingCart, X } from 'lucide-react';
            ...
            <div className="glass-panel desktop-only-checkout" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', height: '100%', position: 'sticky', top: 0, overflowY: 'auto' }}>
                ...
                <div style={{ borderTop: '1px solid var(--border)', paddingTop: '1.5rem', marginTop: 'auto' }}>
                    ...
                    <button
                        ...
                        style={{ width: '100%', fontSize: '1rem', background: 'linear-gradient(135deg, #10b981, #059669)', boxShadow: '0 4px 15px rgba(16, 185, 129, 0.3)' }}
                        onClick={handleSave}
            ...
            {cartArray.length > 0 && (
                <div className="mobile-checkout-bar" style={{ display: isCartOpen ? 'none' : 'block' }}>
                    ...
                    >
                        ...
                        Editar Carrinho ({cartArray.reduce((acc, curr) => acc + curr.quantity, 0)} itens)
                    </button>
                </div>
            )}
